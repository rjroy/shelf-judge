---
title: "Shelf Judge Visual Direction (archived)"
date: 2026-04-05
status: archived
tags: [design, visual, web-ui, historical]
modules: [web-ui]
related:
...
Archived on 2026-09-13 because the visual design is being redone. This palette,
typography, layout, icon concept, and component styling are historical context,
not requirements or an implementation target. Preserve the product behavior in
the active MVP web UI design and vision, but make new visual decisions without
...
- Historical production icon: `.lore/archive/art/icon.webp` — 512×512
- Historical favicon targets: 32×32 and 16×16 PNGs (not retained as active assets)

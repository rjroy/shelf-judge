---
title: "Visual Transition Plan (archived)"
date: 2026-04-05
status: archived
tags: [plan, web-ui, visual, css, historical]
modules: [web-ui]
related:
...
Archived on 2026-09-13 because it implements a visual direction that is being
replaced. Its palette, typography, layout, icon, mockups, and CSS requirements
are historical only. Retain its record of prior implementation work, but do
not use it as a plan or authority for the redesign. The linked MVP design and
vision continue to define product behavior.

## Goal

Transition the Shelf Judge web UI from its current inline-styled state to match the then-approved visual direction and HTML mockups. The functional behavior stayed the same. Only the visual layer changed.
...
**Historical visual direction**: `.lore/archive/designs/visual-direction.md` (superseded)
**Target mockups**:

- `.lore/archive/mockups/mockup-collection-view.html` (historical collection table)
- `.lore/archive/mockups/mockup-game-detail.html` (historical game detail view)
- `.lore/archive/mockups/mockup-axes.html` (historical axes view)
- `.lore/archive/mockups/mockup-bgg-import.html` (historical import view)
...
**9a. Historical record:** the retired icon is retained at `.lore/archive/art/icon.webp`; the old favicon PNG targets were not retained as active assets.
...
2. **Historical icon availability**: the retired icon is retained at `.lore/archive/art/icon.webp`; no favicon generation should be inferred for the redesign from this plan.

...
**Spec**: `.lore/specs/fitness/niche-champion-display.md`
...
Launch a sub-agent that reads the spec at `.lore/specs/fitness/niche-champion-display.md`, reviews the implementation across all packages, and flags any requirements not met. This step is not optional.

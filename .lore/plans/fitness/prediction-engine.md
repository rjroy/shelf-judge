...
**Spec**: `.lore/specs/fitness/prediction-engine.md`
**Brainstorm**: `.lore/brainstorms/prediction-engine.md`
**Shared infrastructure context**: `.lore/specs/collection/collection-profiling.md` (consumes same feature vectors)

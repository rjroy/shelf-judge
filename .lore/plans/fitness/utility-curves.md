...
**Spec**: `.lore/specs/fitness/utility-curves.md`
...
4. Launch a sub-agent to read the spec at `.lore/specs/fitness/utility-curves.md` and verify each of the 28 requirements against the implementation. The agent checks:

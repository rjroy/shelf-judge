...
related:
  [
    .lore/specs/infra/daemon-logger.md,
    .lore/issues/infra/daemon-logger-factory.md,
    .lore/retros/incident/bgg-import-double-request.md,
  ]
---
...
**Spec**: `.lore/specs/infra/daemon-logger.md`
...
4. Launch a fresh-context sub-agent to review the implementation against the spec. The sub-agent reads `.lore/specs/infra/daemon-logger.md` and all modified files, checking each REQ-LOG-\* requirement.

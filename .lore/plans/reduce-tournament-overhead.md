...
**Parent spec**: `.lore/specs/tournament-ranking.md`
...
1. **Launch a review sub-agent** that reads the spec at `.lore/specs/reduce-tournament-overhead.md`, reviews the implementation across all changed files, and flags any requirements not met.

...
4. Launch a sub-agent to read the spec at `.lore/specs/tournament-ranking.md` and verify each of the 20 requirements against the implementation. The agent checks:

...
- The MVP web UI design (`.lore/reference/designs/mvp-web-ui.md`) established that clicking a game in the collection opens its detail view. This spec extends that intent to every surface.
- The collection profiling spec (`.lore/archive/specs/collection/collection-profiling.md`) introduced the divergence and outlier views where game names appear without links.

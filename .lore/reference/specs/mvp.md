...
- [Vision](.lore/reference/vision.md): Project direction and guiding principles (transparency, personal agency, deterministic math)
- [Fitness Model Brainstorm](.lore/work/brainstorm/fitness-model-options.md): Explored 4 scoring approaches; Approach 1 (axis scorecard) selected for MVP with hybrid as long-term direction
- [BGG API Research](.lore/archive/research/bgg-api.md): API endpoints, auth requirements, rate limiting, XML parsing quirks
...
- [Data Model Design](.lore/reference/designs/mvp-data-model.md): Game, Axis, Collection, and Storage structures
- [Fitness Model Design](.lore/reference/designs/mvp-fitness-model.md): Weighted average algorithm, score breakdown interface, worked example
- [BGG Integration Design](.lore/reference/designs/mvp-bgg-integration.md): Endpoints, rate limiting, caching, XML parsing
- [API Surface Design](.lore/reference/designs/mvp-api-surface.md): Operations, request/response shapes, service layer
- [Web UI Design](.lore/reference/designs/mvp-web-ui.md): Screens and navigation
- [CLI Design](.lore/reference/designs/mvp-cli.md): Commands, output format, daemon management

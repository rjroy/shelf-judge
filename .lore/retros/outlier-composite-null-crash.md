...
date: 2026-04-11
status: complete
tags: [bug, regression, nan, json-serialization, feature-vector, silent-failure]
modules: [daemon, profile-engine, feature-vector, web-profile]
related: [.lore/specs/collection-profiling.md]
---
...
- Related spec: `.lore/specs/collection-profiling.md`

...
- `.lore/specs/tournament/tournament-ranking.md` — parent spec for tournament sessions and filter types.
- `.lore/plans/tournament/tournament-ranking.md` — defines `SessionFilterType` and the original exact-match `bggTag` semantics.

...
modules: [web-ui]
related:
  - .lore/issues/collection/game-links.md
...
- The collection profiling spec (`.lore/specs/collection/collection-profiling.md`) introduced the divergence and outlier views where game names appear without links.

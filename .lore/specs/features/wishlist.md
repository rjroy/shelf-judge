...
req-prefix: WISH
related:
  - .lore/issues/features/wishlist.md
  - .lore/vision.md
  - .lore/specs/mvp.md
...
- [Issue: Wishlist](.lore/issues/features/wishlist.md): The original request. "Add Game should allow adding to a wishlist... preview information like on the Add Game screen... help a user understand fitness."
...
- [Spec: Niche Champion Display](.lore/specs/fitness/niche-champion-display.md): Defines `NicheImpact` type used in wishlist entries.
- [Spec: Prediction Engine](.lore/specs/fitness/prediction-engine.md): Defines prediction stages, confidence levels, and the `PredictedGameResponse` shape.

...
- `.lore/specs/collection/collection-profiling.md` (implemented, shares feature-vector.ts)
- `.lore/designs/mvp-fitness-model.md` (current FitnessResult types being extended)
- `.lore/specs/fitness/utility-curves.md` (curves make BGG-derived prediction exact)
- `.lore/specs/tournament/tournament-ranking.md` (tournament data as prediction input)

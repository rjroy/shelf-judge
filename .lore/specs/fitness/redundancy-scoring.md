...
related:
  ...
  - .lore/specs/fitness/niche-champion-display.md
...
- [Spec: Niche Champion Display](.lore/specs/fitness/niche-champion-display.md): Stage 1 of the graduated approach. This spec is Stages 2 and 3. The niche champion display's cluster-based niches and this spec's pairwise penalties are complementary, not competing.
...
- [Spec: Prediction Engine](.lore/specs/fitness/prediction-engine.md): Establishes the `PredictionSettings` pattern (REQ-PRED-25a) that `RedundancySettings` follows. Prediction output is consumed by redundancy (one-way dependency).
...
- [Issue: Deferred Redundancy Scoring](.lore/issues/fitness/deferred-redundancy-scoring.md): The issue that triggered the brainstorm and this spec.

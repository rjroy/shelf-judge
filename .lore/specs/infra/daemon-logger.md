...
This issue was surfaced during the BGG import double-request bug investigation (`.lore/retros/incident/bgg-import-double-request.md`). The retro explicitly noted: "Logging at integration boundaries is not optional. 'Add logging later' means 'debug blind until someone complains.'" The logging itself was added in that fix; this spec addresses the remaining cleanup of centralizing the format.

...
- `.lore/archive/research/bgg-api.md` (Thing endpoint fields, `versions=1` parameter)
...
- `.lore/work/brainstorm/redundancy-scoring.md` (niche display, similarity infrastructure)
- `.lore/work/issues/shelf-layout-designer.md` (original idea)

...
tags: [deferred]
modules: [web]
related: [.lore/reference/specs/collection/collection-filter-sort.md]
---

# Deferred Filter Types

The filter/sort spec (`.lore/reference/specs/collection/collection-filter-sort.md`, lines 178-188) lists 8 filter types explicitly deferred from the first pass:

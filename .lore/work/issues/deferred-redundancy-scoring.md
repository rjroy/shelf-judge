...
- The fitness model design (`.lore/reference/designs/mvp-fitness-model.md`) treats each game independently. Redundancy would need a second pass that adjusts scores based on collection composition.

...
- `.lore/reference/designs/mvp-bgg-integration.md` (enumerate all tag types including families)
- `.lore/archive/specs/collection/collection-profiling.md` (feature vector inputs reference mechanics/categories but not families)

...
source: .lore/archive/designs/shelf-judge-color-system.md
modules: [web-ui]
---

# Migration Notes: Color System Consolidation

These notes describe the historical migration of `packages/web/app/globals.css` from its pre-consolidation state to the former `:root` block defined in [`.lore/archive/designs/shelf-judge-color-system.md`](../../archive/designs/shelf-judge-color-system.md). That system is archived and not a current design authority.

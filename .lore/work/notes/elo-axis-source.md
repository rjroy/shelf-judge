...
source: .lore/work/plans/elo-axis-source.md
...
- Phase 8 doc-strike checklist for `.lore/reference/specs/fitness/prediction-engine.md`: lines 27, 29, 93 (REQ-PRED-16), 95 (REQ-PRED-17), 117, 133 (REQ-PRED-28), 163, 193, 205, 225, 263, 266, 267 — all reference the removed tension surface.

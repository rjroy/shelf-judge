...
**Spec**: `.lore/reference/specs/collection/collection-filter-sort.md`
**Visual mockup**: `.lore/work/mockups/mockup-collection-filter-sort.html` (three panels: desktop full state, desktop axis-sort, mobile)
...
The HTML mockup (`.lore/work/mockups/mockup-collection-filter-sort.html`) establishes:

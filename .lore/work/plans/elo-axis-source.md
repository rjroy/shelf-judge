...
related:
  ...
  - .lore/work/plans/tournament-ranking.md
  - .lore/work/plans/prediction-engine.md
---
...
**Spec**: `.lore/reference/specs/tournament/elo-axis-source.md`
**Related plans (templates and prior surface)**:

- `.lore/work/plans/tournament-ranking.md` — divergence flag code paths to delete
- `.lore/work/plans/prediction-engine.md` — tension panel and tournament stability touch points
...
1. `tournament-ranking.md`:
   - Add a supersession note at the top of "Key Decision: ELO and Axis Fitness Are Peers, Not Parent-Child" pointing to `.lore/reference/specs/tournament/elo-axis-source.md`. Keep the section visible but mark it superseded.
...
1. Reads `.lore/reference/specs/tournament/elo-axis-source.md`.

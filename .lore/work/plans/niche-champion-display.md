...
**Spec**: `.lore/reference/specs/fitness/niche-champion-display.md`
**Brainstorm**: `.lore/work/brainstorm/redundancy-scoring.md` (Proposal 5, Proposal 6 Stage 1)
...
Launch a sub-agent that reads the spec at `.lore/reference/specs/fitness/niche-champion-display.md`, reviews the implementation across all packages, and flags any requirements not met. This step is not optional.

...
**Spec**: `.lore/reference/specs/fitness/prediction-engine.md`
**Brainstorm**: `.lore/work/brainstorm/prediction-engine.md`
**Shared infrastructure context**: `.lore/archive/specs/collection/collection-profiling.md` (consumes same feature vectors)
**Distance metric research**: `.lore/archive/research/outlier-distance-metric.md`
...
**Web** (layout and visual treatment defined in `.lore/work/mockups/prediction-engine.html`):
...
**Design target**: `.lore/work/mockups/prediction-engine.html` — 5 mockup sections define the visual language and layout. All UI decisions below reference this mockup. Open the mockup in a browser for visual reference while implementing.

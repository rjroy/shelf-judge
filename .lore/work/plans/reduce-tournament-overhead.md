...
1. **Launch a review sub-agent** that reads the spec at `.lore/reference/specs/tournament/reduce-tournament-overhead.md`, reviews the implementation across all changed files, and flags any requirements not met.

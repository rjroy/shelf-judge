...
related:
  [.lore/work/plans/llm-narrative.md, .lore/commissions/commission-Thorne-20260411-174549.md]
---
...
- **The plan prescribed the bug.** `.lore/work/plans/llm-narrative.md:224` explicitly specified `isAvailable()` checks `ANTHROPIC_API_KEY`. The implementer followed the plan faithfully. Nobody checked whether the gate's premise matched how the Agent SDK actually authenticates.
...
- Plan that prescribed the gate: `.lore/work/plans/llm-narrative.md` (see Phase 2, section on `isAvailable()`)

...
const divergence: TournamentDivergenceInsight[] = [
  {
    ...
    confidence: {
      level: "moderate",
      basis: "Ten Tournament comparisons meet the reporting threshold",
    },
  },
  {
    contractVersion: 1,
...
const outliers: CollectionOutlier[] = [
  {
    ...
    notability: {
      ...
      threshold: 0.5,
      direction: "above",
      explanation: "The mean distance exceeds 0.5 with a material factual driver",
    },
    confidence: {
      level: "moderate",
      basis: "Six owned games passed factual metadata coverage gates",
    },
  },
  {
    contractVersion: 1,
